...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.bulkInsert('products', [{
      ...
      price: 695,
      description: 'From our Legends Collection, the Naga was inspired by the mythical water dragon that protects the ocean pearl. Wear facing inward to be bestowed with love and abundance, or outward for protection.',
      category: 'jewelery',
